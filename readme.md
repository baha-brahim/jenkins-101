...
## Suggested Jenkins pipeline (Jenkinsfile)
Below is a simple declarative pipeline you can use as a starting point. Put this in a `Jenkinsfile` in your project repository and create a multibranch pipeline or pipeline job in Jenkins.
